...
Secondly, we used the predictions from the machine learning models trained on local data.
Thirdly, we combined the predictions from the machine learning models and the environmental coviarates in one model.
Fourthly, we used predictions from the machine learning models trained on the global data.
