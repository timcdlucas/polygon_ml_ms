...
This process of stacking models has proven effective in many realms however typical stacking uses a single dataset on a consistent scale \cite{sill2009feature, bhatt2017improved}. 
...
For each region we fitted five models via caret \cite{caret}: elastic net \cite{enet}, Random Forest \cite{wright2015ranger}, projection pursuit regression \cite{friedman1981projection}, neural networks \cite{nnet} and boosted regression trees \cite{gbm}.
