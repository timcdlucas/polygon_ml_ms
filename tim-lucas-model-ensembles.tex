...
We find that, in four national case studies, using a disaggregation regression model to combine predictions from machine learning models trained on prevalence point-surveys improves model accuracy relative to a baseline disaggregation regression model that uses linear effects of the raw environmental covariates only.                                  
...
These variables were used as covariates in the machine learning models as well as being used directly as covariates the baseline dissaggregation regression models.
...
We used the raw environmental covariates described above.
