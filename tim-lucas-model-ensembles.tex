...
% reconsider. scatter plot?
% rmse ~ beta. facet as country, colour as global vs local. do on full model not CV. Need to include global vs local.
%
% Or table:
% Country Model       RMSE beta_local beta_global beta_local+global
% MDG     RF local    12   0.1        -           0.2    
% MDG     RF global   14   -          0.4         0.3
% COL     nnet local  200  0.01       -           0.0001   
